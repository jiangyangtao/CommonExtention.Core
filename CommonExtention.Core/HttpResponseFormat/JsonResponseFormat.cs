...
namespace CommonExtention.Core.HttpResponseFormat
{
    ...
    public sealed class JsonResponseFormat
    {
        ...
        /// <returns></returns>
        private JsonResult Json<T>(T response) where T : class
        {
        ...
        /// </returns>
        public JsonResult ResponseSuccess<T>(T data, int count = 0) => Json(new ResponseEntity()
        {
            Code = 0,
            Data = data,
        ...
        /// Json格式 : {code:0,rows:data,total:1,message:Success}
        /// </returns>
        public JsonResult ResponseGridResult<T>(T data, int count = 0) => Json(new ResponseGridEntity()
        {
            Code = 0,
            Rows = data,
