...
namespace CommonExtention.Core.Extensions
{
    ...
    {
        #region 将当前 IFormFile 对象读取到 DataSet
        /// <summary>
        /// 将当前 <see cref="IFormFile"/> 对象读取到 <see cref="DataSet"/>
        /// </summary>
        ...
        /// </returns>
        public static DataSet ReadToDataSet(this IFormFile formFile,  bool firstRowIsColumnName = true, bool addEmptyRow = false)
            => new Excel().ReadFormFileToDataSet(formFile,  firstRowIsColumnName, addEmptyRow);
