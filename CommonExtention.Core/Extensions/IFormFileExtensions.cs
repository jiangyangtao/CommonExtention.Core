...
namespace CommonExtention.Core.Extensions
{
    ...
    public static class IFormFileExtensions
    {
        ...
        #region 将当前 IFormFile 对象用异步方式读取到 DataTable
        /// <summary>
        /// 将当前 <see cref="IFormFile"/> 对象用异步方式读取到 <see cref="DataTable"/>
        /// </summary>
        /// <param name="formFile"><see cref="IFormFile"/>对象</param>
        /// <param name="sheetName">指定工作薄 sheet 的名称</param>
        /// <param name="firstRowIsColumnName">首行是否为 <see cref="DataColumn.ColumnName"/></param>
        ...
        /// 否则返回从 <see cref="IFormFile"/>读取后的 <see cref="DataTable"/> 对象。
        /// </returns>
        public static async Task<DataTable> ReadToDataTableAsync(this IFormFile formFile, string sheetName = null, bool firstRowIsColumnName = true,
            bool addEmptyRow = false) => await new Excel().ReadFormFileToDataTableAsync(formFile, sheetName, firstRowIsColumnName, addEmptyRow);
        ...
        #region 将当前 IFormFile 对象用异步方式读取到 ICollection<DataTable>
        /// <summary>
        /// 将当前 <see cref="IFormFile"/> 对象用异步方式读取到 <see cref="ICollection{DataTable}"/>
        /// </summary>
        /// <param name="formFile"><see cref="IFormFile"/>对象</param>
        /// <param name="firstRowIsColumnName">首行是否为 <see cref="DataColumn.ColumnName"/></param>
        /// <param name="addEmptyRow">是否添加空行，默认为 false，不添加</param>
        ...
        /// 其中一个 <see cref="DataTable"/> 对应一个 Sheet 工作簿。
        /// </returns>
        public static async Task<ICollection<DataTable>> ReadToTablesAsync(this IFormFile formFile, bool firstRowIsColumnName = true, bool addEmptyRow = false)
            => await new Excel().ReadFormFileToTablesAsync(formFile, firstRowIsColumnName, addEmptyRow);
